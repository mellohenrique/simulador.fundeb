...
simular_modelo_hibrido_tempo <- function(base_alunos, ponderador, base_socioeconomica, base_financas, auxilio_federal = 0.1, auxilio_federal_vaa = 0.05, equalizacao_socio = FALSE, distribuicao_fundo_estadual_socio = FALSE, crescimento_economico, crescimento_demografico, ...){
  ...
  purrr::map2_dfr(lista_alunos,
                  lista_fundos,
                  ~simular_modelo_hibrido(base_alunos, ponderador, base_socioeconomica, base_financas, auxilio_federal = auxilio_federal, auxilio_federal_vaa = auxilio_federal_vaa, equalizacao_socio = FALSE, distribuicao_fundo_estadual_socio = FALSE, ...),
                  .id = "ano")
}
