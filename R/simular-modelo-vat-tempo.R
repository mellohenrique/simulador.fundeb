...
simular_modelo_vat_tempo <- function(base_alunos, ponderador, base_socioeconomica, base_financas, auxilio_federal = 0.1, equalizacao_socio = FALSE, distribuicao_fundo_estadual_socio = FALSE, crescimento_economico, crescimento_demografico, ...){
  ...
  purrr::map2_dfr(lista_alunos,
                  lista_fundos,
                  ~simular_modelo_vat(.x, ponderador, base_socioeconomica, .y, auxilio_federal = auxilio_federal, equalizacao_socio = equalizacao_socio, distribuicao_fundo_estadual_socio = distribuicao_fundo_estadual_socio, ...),
                  .id = "ano")
}
