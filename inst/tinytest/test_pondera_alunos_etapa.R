# Teste para função pondera_matriculas_etapa----
## Autor: Henrique de Assunção
## Data: 25/05/2021
## Testes para função de pnderar matriculas por etapa

# Configuração ----

## Cria bases de teste
df_teste = simulador.fundeb:::pondera_matriculas_etapa(
...
## Testando ponderacao de matriculas entre tipos diferentes de teste
df_teste = df_teste[order(df_teste$ibge),]

expect_equal(df_teste$matriculas_vaaf,
...
expect_equal(df_teste$matriculas_vaat,
